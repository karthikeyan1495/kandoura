...
public class AcceptedStatusChanges extends java.util.Observable {
    Activity activity;
    OrderList orderList;
    MyProgressDialog myProgressDialog;

    public AcceptedStatusChanges(Activity activity, OrderList orderList) {
    ...
    public void OnClickstatuschanges(View view) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.accepttab, popupMenu.getMenu());
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (R.id.accept == id) {
                    ...
                    updateAPICall(orderList.getOrder_id(), "processing");
                    popupMenu.dismiss();
                }
