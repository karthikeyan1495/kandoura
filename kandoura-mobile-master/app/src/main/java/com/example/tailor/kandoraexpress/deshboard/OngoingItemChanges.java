...
public class OngoingItemChanges extends java.util.Observable {

    Activity activity;
    OrderList orderList;
    MyProgressDialog myProgressDialog;

    public OngoingItemChanges(Activity activity, OrderList orderList) {
    ...
    private void updateAPICall(String orderId) {

        if (InternetChecker.getInstance().isReachable()) {
            myProgressDialog.showDialog(activity);
            APICall api = APIConfiguration.getInstance().createService(APICall.class);
           Observable<Response<GeneralResponse>> observable = api.orderststuschange(orderId,"dispatch" ,MySession.getInstance(activity).getUser().getToken());
    ...
    public void OnClickorderdetailinfo(View view){
